...
public class EventsActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		new DoEventParseInBackground(this).execute();
...
class DoEventParseInBackground extends AsyncTask<Void, Void, ArrayList<News>>{
	private Context c1;
	
	public DoEventParseInBackground(Context context) {
		c1 = context;
	}
	...
	protected ArrayList<News> doInBackground(Void... arg0) {
        ...
        try {
		    ...
		    xr.parse("http://www.cs.auckland.ac.nz/uoa/home/template/events_feed.rss?category=other_events");
	...
	protected void onPostExecute(final ArrayList<News> newsList) {
		...
		ArrayAdapter adapter = new ArrayAdapter(c1, android.R.layout.simple_list_item_2, android.R.id.text1, newsList) {
			...
			ListView lv = (ListView) ((Activity) c1).findViewById(R.id.eventsSimpleList);
